...
"""
def get_simple_classifier(flat_size = 28 * 28, num_labels = 10, num_hidden = 32, verbose = True, l2_regularization_constant = 0.0, dropout_rate = 0.4):
    ...
    model.add(keras.layers.Dropout(rate=dropout_rate,input_shape=(flat_size,)))
...
"""
def get_deeper_classifier(flat_size=28*28, num_labels=10, num_hidden=[128, 96, 64, 32], verbose=True, dropout_rate=0.4):
